...
export default function ApproachPage() {
  ...
  const pillars = [
    { icon: "🧠", title: "Knowledge-First", desc: "Deep understanding before practice — we never skip the 'why'", color: "from-red-500 to-orange-500" },
    { icon: "💪", title: "Skill-Based Training", desc: "Practical drills, simulations, and real applications every session", color: "from-red-600 to-red-500" },
    { icon: "🤝", title: "Community Support", desc: "Peer learning, group sessions, and mentorship throughout", color: "from-rose-500 to-red-500" },
    { icon: "📊", title: "Progress Tracking", desc: "Regular assessments and feedback for consistent growth", color: "from-red-400 to-rose-500" },
    { icon: "🏆", title: "Outcome-Focused", desc: "Every course is designed around measurable, life-changing results", color: "from-orange-500 to-red-500" },
  ];

  const stats = [
    { num: "94%", label: "Completion Rate", icon: "✅", trend: "+12%" },
    { num: "4.9", label: "Avg. Rating", icon: "⭐", trend: "Excellent" },
    { num: "87%", label: "Career Impact", icon: "📈", trend: "+23%" },
    { num: "100%", label: "Recommend", icon: "👍", trend: "Guaranteed" },
  ];
    ...
    <div className="min-h-screen pt-28 pb-20 bg-gradient-to-b from-white via-gray-50 to-white">
      <section ref={sectionRef} className="px-6">
        <div className="max-w-7xl mx-auto">
                  ...
                  >
                    <div className="flex gap-6 items-start">
                      ...
                      <div className="flex-1 bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 group-hover:border-red-200">
                        ...
                        {/* Expandable Detail */}
                        <div className={`mt-3 overflow-hidden transition-all duration-300 ${activeStep === idx ? 'max-h-20 opacity-100' : 'max-h-0 opacity-0'}`}>
            ...
            <div className="space-y-6">
              ...
              <div className={`bg-white rounded-2xl p-6 shadow-lg border border-gray-100 transition-all duration-700 hover:shadow-xl ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`} style={{ transitionDelay: '200ms' }}>
                ...
                <div className="space-y-3">
                  {pillars.map((pillar, idx) => (
                    ...
                    >
                      <div className={`w-12 h-12 bg-gradient-to-br ${pillar.color} rounded-xl flex items-center justify-center text-xl transition-transform duration-300 group-hover:scale-110 shadow-md`}>
                        {pillar.icon}
                      </div>
              ...
              <div className={`text-center transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '600ms' }}>
                <div className="inline-flex items-center gap-2 bg-gray-100 rounded-full px-4 py-2">
                  ...
                  <span className="text-xs text-gray-600">⭐ 3,200+ successful graduates</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Bottom CTA Banner */}
          <div className={`mt-16 bg-gradient-to-r from-red-50 to-white rounded-2xl p-8 text-center border border-red-100 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '700ms' }}>
